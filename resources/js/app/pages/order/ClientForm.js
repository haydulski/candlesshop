...
function ClientForm({ getter, data }) {
    ...
    return (
        <Form>
            ...
            <Input type="text" id="mobile" placeholder="Contact Phone" value={data.mobile} onChange={(e) => handleChange(e)} />
            ...
            <textarea type="text" id="message" placeholder="Your message..." onChange={(e) => handleChange(e)} value={data.message} />
        </Form>
    );
}
